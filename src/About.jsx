const  About=()=> {
  ...
  return (
    <div className=" bg-[#0f1b34]  flex flex-col gap-10 md:flex-row items-center justify-start md:justify-center absolute top-10 w-full  h-full dark:bg-slate-100 overflow-y-scroll">
      <div className="md:w-[40%] xssm:h-[35%] xs:h-auto w-[85%] flex  md:justify-center justify-start md:items-center  items-start hover:scale-105 duration-150">
...
<div className="flex gap-5"> <p className="text-white">Phone</p> 	<p className="text-[0.8rem] xs:text-xl">+251 963-13-02-18</p></div>
 ...
 <div className="flex gap-5"><p className="text-white">Address</p> <p className="text-[0.8rem] xs:text-xl">Addis Ababa, Ethiopia</p> </div>
  ...
  <a href="hilinasResume.pdf" className="button flex items-center justify-center xs:text-sm text-xs xs:w-1/3  md:w-auto md:px-10">DownLoad Resume</a>
