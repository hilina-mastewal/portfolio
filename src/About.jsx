const  About=()=> {
  ...
  return (
    <div className=" bg-[#0f1b34]  flex flex-col md:flex-row items-center justify-center absolute top-10 w-full  h-full dark:bg-slate-100 overflow-x-scroll">
      <div className="md:w-[45%] h-[35%] xs:h-auto w-[85%] flex justify-center xs:mt-0 items-center hover:scale-105 duration-150">
    ...
    <img
        ...
        className="md:w-[300px] md:h-[300px] h-1/2 w-1/2 opacity-[0.55] rounded-2xl xs:my-10  my-5 md:my-10 xs:mr-0 mr-12 md:mr-32 hover:opacity-100"
        alt="mypicture"/>
  ...
  <div className=" md:w-[60%] md:h-full flex flex-col justify-center items-center  md:pt-32  md:items-start gap-10  ">
...
<div className="flex gap-5"> <p className="text-white">Phone</p> 	<p>+251 963-13-02-18</p></div>
 ...
 <div className="flex gap-5"><p className="text-white">Address</p> <p>Addis Ababa, Ethiopia</p> </div>
  ...
  <a href="myResume.docx" className="button flex items-center justify-center xs:text-lg text-xs mb-28 xs:w-1/3  w-8/12 md:w-3/12">DownLoad Resume</a>
