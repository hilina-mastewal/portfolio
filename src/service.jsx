...
const  Service=()=> {
  ...
  <div className=" md:w-[10%] md:h-full flex justify-start  items-center ">
     <div className=" text-4xl xs:text-5xl font-medium text-[#d8dffe] md:pt-20 md:-rotate-90 ">My  Skills</div> 
     </div>
  ...
  working with one another in relation to several global class instance. 
    </div> 
    <div className="w-[80%]  py-20 pt-7 md:pt-0 grid grid-cols-2 sm:grid-cols-3 xs:grid-cols-4 gap-9  md:gap-3 ">
      
        <div className="md:w-[200px]  flex flex-col justify-evenly items-center md:h-[200px]  shadow-2xl ">
