...
const  Contact=()=> {
  ...
  <div className="md:w-[55%] h-1/2 xs:mt-10 md:h-full md:mt-20 flex flex-col xs:pt-[10%] md:pt-0 md:items-start gap-5 md:pl-20  pl-4">
     <div>
...
<lable className=" font-thin md:text-base xs:text-2xl text-base text-[#80b3cb]">Addis Ababa, Ethiopia</lable>
    ...
    <div className="md:w-[50%] w-full  flex flex-col h-1/2 mt-10 md:mt-0 md:items-start  items-center xs:h-full">
