...
const  Home=()=> {
  ...
  <div className="flex flex-col gap-10">
   <div className=" text-base xs:text-xl font-thin text-[#80b3cb]   ">I am computer science student.I currently learning  at hilcoe(school of science and technology). Im
    focused on building accessible human centered product  at upstatement
   </div>
   <div><Link  to='/Contact' className="button font-bold  py-10  px-20  ">Contact me</Link></div></div>
    </div>
    </div>
